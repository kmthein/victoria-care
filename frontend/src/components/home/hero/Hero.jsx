    ...
    <div className="relative">
      ...
      <div className="w-full md:w-[80%] mx-auto relative">
        ...
        {/* <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 0.5, duration: 1 }}
          className="py-8 px-8 md:py-12 md:px-12 bg-[#c0e9fd] opacity-40 absolute rounded-full top-[450px] xl:top-[380px] 2xl:top-[580px] left-[90%] z-10"
        ></motion.div> */}
      ...
      <div className=" xl:mt-[-80px] 2xl:mt-0 w-full z-[1000] mt-12">
        <img src={wave} alt="wave" className="w-full h-[100px] md:h-auto " />
      </div>
    </div>
  );
};
