      ...
      <div className=" flex flex-col-reverse xl:flex xl:flex-row py-[120px]">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2, duration: 0.5 }} className="  relative w-full xl:w-[50%]">
          <img
            ...
            alt="img1"
          />
          <div className=" border-[12px] absolute top-[80px] xl:top-60 left-40 md:top-[120px] md:left-[400px] border-white rounded-xl">
            <img
              src={img2}
              className="w-[180px] h-[140px] xl:w-[280px] xl:h-[200px] object-cover rounded-lg"
              alt="img2"
            />
          </div>
        </motion.div>
